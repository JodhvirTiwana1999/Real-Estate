      ...
      <>
       ...
       {/* this is top section for service */}
         <div className='pt-6 xs:block sm:hidden text-center'>
                <h4 className='xs:block sm:hidden xs-text-[23px] text-[16px] sm:mt-[20px]  lg:mt-[42px] min-w-[180px]'><span><img src="../public/image/line-about.svg" className='inline mr-3' alt="line"/></span>Services<span><img src="../public/image/line-about.svg" className='inline ml-3' alt="line"/></span></h4>
         </div>
       <section data-aos="fade-left" className='xs:h-auto xs:py-4 lg:py-8 lg:h-[572px] bg-[#FFFAFA] flex text-black sm:gap-[20px] md:gap-[50px] lg:gap-[90px] px-3 xs:flex-col sm:flex-row-reverse '>
             <div className='xs:w-[100%] sm:w-[50%] flex items-center justify-center'>
                    <img src="../public/image/Service/background-1.svg" className='sm:min-w-[260px] md:min-w-[350px]' alt="about"/>
               </div>
               <div data-aos="fade-right" className='xs:w-[100%] sm:w-[50%] '>
                      <h4 className='xs:hidden sm:block text-[16px] sm:mt-[20px] lg:mt-[42px] min-w-[180px] sm:mb-[8px]'><span><img src="../public/image/line-about.svg" className='inline mr-3' alt="line"/></span>Services<span><img src="../public/image/line-about.svg" className='inline ml-3' alt="line"/></span></h4>
                    ...
                    <ul  className='xs:mt-4 xs:grid xs:grid-cols-1 xm:grid-cols-2 xs:gap-[12px] sm:block'>
                         <li className='xs:text-[14px] md:text-[15px] lg:text-[18px] sm:mt-[20px] md:mt-[20px] lg:mt-[35px] truncate w-55'><span ><img src="../public/image/check-box-about.svg" className='inline mr-2' alt="check" /></span>Multi-Unit Residences (Duplexes Triplexes etc.)</li>
                         <li className='xs:text-[14px] md:text-[15px] lg:text-[18px] sm:mt-[15px] md:mt-[15px] lg:mt-[25px] truncate w-55'><span ><img src="../public/image/check-box-about.svg" className='inline mr-2' alt="check" /></span>Total Satisfaction Guarantee</li>
                         <li className='xs:text-[14px] md:text-[15px] lg:text-[18px] sm:mt-[15px] md:mt-[15px] lg:mt-[25px] truncate w-55'><span ><img src="../public/image/check-box-about.svg" className='inline mr-2' alt="check" /></span>Industrial Real Estate (Warehouses Factories)</li>
                         <li className='xs:text-[14px] md:text-[15px] lg:text-[18px] sm:mt-[15px] md:mt-[15px] lg:mt-[25px] truncate w-55'><span ><img src="../public/image/check-box-about.svg" className='inline mr-2' alt="check" /></span>Innovation and Development Centers</li>
        ...
        <section className='xs:h-auto xs:py-4 lg:py-8  bg-[#ffffff] flex text-black sm:gap-[20px] md:gap-[50px] lg:gap-[67px] px-3 xs:flex-col sm:flex-row '>
             <div data-aos="fade-left" className='xs:w-[100%] sm:w-[50%] flex items-center justify-center'>
                    <img src="../public/image/Service/background-2.svg" className='sm:min-w-[260px] md:min-w-[350px]' alt="about"/>
               </div>
        ...
        <section className='xs:h-auto xs:py-4 lg:py-8 bg-[#FFFAFA] flex text-black sm:gap-[20px] md:gap-[50px] lg:gap-[90px] px-3 xs:flex-col sm:flex-row-reverse '>
             <div data-aos="fade-left" className='xs:w-[100%] sm:w-[50%] flex items-center justify-center'>
                    <img src="../public/image/Service/background-3.svg" className='sm:min-w-[260px] md:min-w-[350px]' alt="about"/>
               </div>
               <div data-aos="fade-right" className='xs:w-[100%] sm:w-[50%] flex flex-col justify-center'>
                    ...
                    <ul className='xs:mt-4 xs:grid xs:grid-cols-1 xm:grid-cols-2 xs:gap-[12px] sm:block'>
                         <li className='xs:text-[14px] md:text-[15px] lg:text-[18px]  sm:mt-[20px] md:mt-[20px] lg:mt-[35px]  truncate w-58'><span ><img src="../public/image/check-box-about.svg" className='inline mr-2' alt="check" /></span>Customized designs for unique client needs</li>
                         <li className='xs:text-[14px] md:text-[15px] lg:text-[18px]  sm:mt-[15px] md:mt-[15px] lg:mt-[25px] truncate w-58'><span ><img src="../public/image/check-box-about.svg" className='inline mr-2' alt="check" /></span>Innovative solutions blending functionality and style</li>
                         <li className='xs:text-[14px] md:text-[15px] lg:text-[18px]  sm:mt-[15px] md:mt-[15px] lg:mt-[25px] truncate w-58'><span ><img src="../public/image/check-box-about.svg" className='inline mr-2' alt="check" /></span>Detailed planning from concept to completion</li>
                         <li className='xs:text-[14px] md:text-[15px] lg:text-[18px]  sm:mt-[15px] md:mt-[15px] lg:mt-[25px] truncate w-58'><span ><img src="../public/image/check-box-about.svg" className='inline mr-2' alt="check" /></span>Expert guidance through every architectural phase</li>
        ...
        <section className='xs:h-auto xs:py-4 lg:py-8  bg-[#FFFAFA] flex text-black sm:gap-[20px] md:gap-[50px] lg:gap-[90px] px-3 xs:flex-col sm:flex-row '>
             <div data-aos="fade-left" className='xs:w-[100%] sm:w-[50%] flex items-center justify-center'>
                    <img src="../public/image/Service/background-4.svg" className='sm:min-w-[260px] md:min-w-[350px]' alt="about"/>
               </div>
               <div data-aos="fade-right" className='xs:w-[100%] sm:w-[50%] flex flex-col justify-center'>
                    ...
                    <ul className='xs:mt-4 xs:grid xs:grid-cols-1 xm:grid-cols-2 xs:gap-[12px] sm:block'>
                         <li className='xs:text-[14px] md:text-[15px] lg:text-[18px]  sm:mt-[20px] md:mt-[20px] lg:mt-[35px] truncate w-58'><span ><img src="../public/image/check-box-about.svg" className='inline mr-2' alt="check" /></span>Expert guidance in identifying suitable land.</li>
                         <li className='xs:text-[14px] md:text-[15px] lg:text-[18px]  sm:mt-[15px] md:mt-[15px] lg:mt-[25px] truncate w-58'><span ><img src="../public/image/check-box-about.svg" className='inline mr-2' alt="check" /></span>Assistance with legal documentation and paperwork</li>
                         <li className='xs:text-[14px] md:text-[15px] lg:text-[18px]  sm:mt-[15px] md:mt-[15px] lg:mt-[25px] truncate w-58'><span ><img src="../public/image/check-box-about.svg" className='inline mr-2' alt="check" /></span>Assistance with legal documentation and paperwork</li>
                         <li className='xs:text-[14px] md:text-[15px] lg:text-[18px]  sm:mt-[15px] md:mt-[15px] lg:mt-[25px] truncate w-58'><span ><img src="../public/image/check-box-about.svg" className='inline mr-2' alt="check" /></span>Help with due diligence and land verification</li>
       ...
       <section className='xs:h-auto xs:py-4 lg:py-8  bg-[#ffffff] flex text-black md:gap-[50px] lg:gap-[90px] px-3  xs:flex-col sm:flex-row-reverse'>
             <div data-aos="fade-left" className='xs:w-[100%] sm:w-[50%] flex items-center justify-center'>
                    <img src="../public/image/Service/background-5.svg" className='sm:min-w-[260px] md:min-w-[350px]' alt="about"/>
               </div>
               <div data-aos="fade-right" className='xs:w-[100%] sm:w-[50%] flex flex-col justify-center'>
                    ...
                    <ul className='xs:mt-4 xs:grid xs:grid-cols-1 xm:grid-cols-2 xs:gap-[12px] sm:block'>
                         <li className='xs:text-[14px] md:text-[15px] lg:text-[18px]  sm:mt-[20px] md:mt-[20px] lg:mt-[35px] truncate w-58'><span ><img src="../public/image/check-box-about.svg" className='inline mr-2' alt="check" /></span>Metaverse Features in Home.</li>
                         <li className='xs:text-[14px] md:text-[15px] lg:text-[18px]  sm:mt-[15px] md:mt-[15px] lg:mt-[25px] truncate w-58'><span ><img src="../public/image/check-box-about.svg" className='inline mr-2' alt="check" /></span>Energy-saving lighting and appliances</li>
                         <li className='xs:text-[14px] md:text-[15px] lg:text-[18px]  sm:mt-[15px] md:mt-[15px] lg:mt-[25px] truncate w-58'><span ><img src="../public/image/check-box-about.svg" className='inline mr-2' alt="check" /></span>Smartphone-controlled temperature management.</li>
                         <li className='xs:text-[14px] md:text-[15px] lg:text-[18px]  sm:mt-[15px] md:mt-[15px] lg:mt-[25px] truncate w-58'><span ><img src="../public/image/check-box-about.svg" className='inline mr-2' alt="check" /></span>Eco-Friendly Materials</li>
